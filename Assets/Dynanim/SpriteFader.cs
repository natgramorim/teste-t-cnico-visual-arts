...
/// <summary>
/// Realiza fade in e fade out do sprite
/// </summary>
...
public class SpriteFader : MonoBehaviour
{
    ...
    {
        Fade(sprite.color.a, maxAlfa, duração, onFadeInEnd);
    }
    ...
    {
        Fade(sprite.color.a, minAlfa, duração, onFadeOutEnd);
    }
    ...
    public void FadeIn()
    {
        Fade(minAlfa, maxAlfa, duração, onFadeInEnd);
    }
    ...
    public void FadeOut()
    {
        Fade(maxAlfa, minAlfa, duração, onFadeOutEnd);
    }
    ...
    {
        Fade(min, max, duração, onFadeInEnd);
    }
    ...
    {
        Fade(max, min, duração, onFadeOutEnd);
    }
    ...
    {
        Fade(minAlfa, maxAlfa, duração, fadeEvent);
    }
    ...
    {
        Fade(maxAlfa, minAlfa, duração, fadeEvent);
    }

    /// <summary>
    /// Inicia o processo de fade segundo os parâmetros precisos
    /// </summary>
    /// <param name="max"></param>
    /// <param name="min"></param>
    /// <param name="segundos"></param>
    /// <param name="fadeEvent"></param>
    public void Fade(float começo, float final, float segundos, UnityEvent fadeEvent)
    {

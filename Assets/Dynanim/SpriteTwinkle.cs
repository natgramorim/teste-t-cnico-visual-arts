...
/// <summary>
/// Faz o sprite piscar em um ciclo
/// </summary>
public class SpriteTwinkle : MonoBehaviour
{
    ...
    private SpriteRenderer spriteRenderer;                                                          // imagem que vai piscar
    private float oldT;                                                                             // usado para perceber se um ciclo completou
